...
#define HOOK_TRAMP(tramp)                                                                        \
    ({                                                                                           \
        ...
        patch::hook_function_internal(                                                           \
            reinterpret_cast<void *>(_tramp_->src), reinterpret_cast<void *>(_tramp_->override), \
            _tramp_->instrs, reinterpret_cast<void **>(&_tramp_->chain));                        \
    })

...
bool s_exclusive_mode;
bool s_exclusive_mode_request;

mkb::AnalogInputGroup s_merged_analog_inputs;
mkb::DigitalInputGroup s_merged_digital_inputs;
mkb::AnalogInputGroup s_analog_inputs[4];
mkb::PadStatusGroup s_pad_status_groups[4];
...
bool button_repeated(u16 digital_input, bool priority) {

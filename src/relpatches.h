...
struct Tickable {
    ...
    void (*main_loop_init_func)() = nullptr;  // Initialization function on load of
                                              // mkb2.main_loop.rel
    void (*main_game_init_func)() = nullptr;  // Initialization function on load of
                                              // mkb2.main_game.rel
    ...
    void (*draw_stage_func)() = nullptr;      // Called at end of draw_stage() function. mtxB is
                                              // stage->view mtx
    void (*draw_view_stage_func)() = nullptr;  // Called at end of view stage drawing function. mtxB
                                               // is stage->view mtx
    void (*stobj_init_func)() = nullptr;       // Called at end of stobj init function
    void (*stobj_tick_func)() = nullptr;  // Called at end of stobj tick function if game not paused
                                          // (and some other unk flag isn't set)
    void (*stobj_dest_func)() = nullptr;  // Called at end of stobj dest (destructor) function
};

extern const u32 PATCH_COUNT;
extern const u32 MODULE_COUNT;
extern Tickable patches[];
extern Tickable modules[];
